                                ...
                                <div class="row">
                                            ...
                                            <label for="project-priority">Aerolinea</label>
                                                <select id="airline" name="airline" class="form-control select2 airlines_arrival services_llegadas">
                                                    ...
                                                    @foreach ($airlines as $airline)
                                                        <option value=" {{$airline->airline}} ">{{ $airline->iata_code }} - {{ $airline->airline }}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control select time" id="flight_time" name="flight_time" placeholder="{{ date('H:i') }}">
